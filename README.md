...
Скрипт для отправки письма с приложением на определенный е-мейл. Опционально, умеет формировать zip-архив для отправки. Для корректной работы нужен Powershell 5.1 и выше.
